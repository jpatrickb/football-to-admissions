    ...
    <div className="app-root">
      <header className="navbar">
        <div className="navbar-inner">
          <a className="brand brand-title" href="https://github.com/jpatrickb/football-to-admissions" target="_blank" rel="noreferrer">
            Football Performance and Admissions
          </a>
      ...
      <footer className="footer container">© {new Date().getFullYear()} Football & Admissions</footer>
    </div>
  )
}
